...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed right-4 top-4 z-50 flex h-9 w-9 items-center justify-center rounded-full border border-border bg-surface text-base transition hover:border-accent"
    >
      {theme === "dark" ? "☀️" : "🌙"}
    </button>
  );
